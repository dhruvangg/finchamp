                ...
                <Page>
                    <Container>
                        ...
                        <div className="flex items-start justify-between">
                            ...
                            <div>
                                <ReactToPrint trigger={() => <a href="javascript:;" className="flex items-center justify-center ml-auto w-24 bg-gray-100 p-2 rounded-lg">
                                ...
                                <tbody className="border">
                                    {this.state.months.map((el, i) => {
                                        return <tr key={i}>
                                            ...
                                            <td scope="col" className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 border-r">{formatNumber(income)}</td>
                                            <td scope="col" className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 border-r">{formatNumber(expenses)}</td>
                                            <td scope="col" className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 border-r">{formatNumber(emi)}</td>
                                            <td scope="col" className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 border-r">{formatNumber(investment)}</td>
                                            <td scope="col" className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 border-r">{formatNumber(medical)}</td>
                                        </tr>
                                    })}
                                </tbody>
                                <tfoot>
                                    <tr>
                                        ...
                                        <th className="text-sm font-bold text-gray-900 px-6 py-4">{formatNumber(income * months.length)}</th>
                                        <th className="text-sm font-bold text-gray-900 px-6 py-4">{formatNumber(expenses * months.length)}</th>
                                        <th className="text-sm font-bold text-gray-900 px-6 py-4">{formatNumber(emi * months.length)}</th>
                                        <th className="text-sm font-bold text-gray-900 px-6 py-4">{formatNumber(investment * months.length)}</th>
                                        <th className="text-sm font-bold text-gray-900 px-6 py-4">{formatNumber(medical * months.length)}</th>
                                    </tr>
